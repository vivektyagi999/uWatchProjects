...
namespace uWatch
{
	public class CustomImageGallery : ScrollView
	{
		...
		public static readonly BindableProperty ItemsSourceProperty =
			BindableProperty.Create<CustomImageGallery, IList>(
				view => view.ItemsSource,
				default(IList),
				BindingMode.TwoWay,
				propertyChanging: (bindableObject, oldValue, newValue) =>
				{
					((CustomImageGallery)bindableObject).ItemsSourceChanging();
				},
				propertyChanged: (bindableObject, oldValue, newValue) =>
				{
					((CustomImageGallery)bindableObject).ItemsSourceChanged(bindableObject, oldValue, newValue);
				}
			);
		...
		public static readonly BindableProperty SelectedItemProperty =
			BindableProperty.Create<CustomImageGallery, object>(
		...
		public static readonly BindableProperty SelectedIndexProperty =
			BindableProperty.Create<CustomImageGallery, int>(
